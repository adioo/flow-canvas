...
class Button {
    ...
    constructor(ctx, text, options = {}) {
        ...
        this.color.background = this.color.background || '#0078e7'
        this.color.font = this.color.font || 'White';
        this.color.hover = this.color.hover || {};
        this.color.hover.background = this.color.hover.background || this.color.background;
    ...
    draw (x, y) {
        ...
        this.ctx.fillStyle = this.isMouseOver ? this.color.hover.background : this.color.background;
        this.ctx.fill();
        ...
        let textWidth = Math.round(this.ctx.measureText(this.text).width);
        let textX = this.x + 25 / 2;
